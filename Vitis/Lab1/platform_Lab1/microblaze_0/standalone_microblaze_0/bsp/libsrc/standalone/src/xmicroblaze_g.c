...
XMicroblaze_Config XMicroblaze_ConfigTable[] __attribute__ ((section (".drvcfg_sec"))) = {
	{
		...
		0x10000,  /* d-cache-size */
		0x10,  /* i-cache-line-size */
		0x10000,  /* i-cache-size */
		0xb,  /* xlnx,addr-tag-bits */
		...
		0x1,  /* xlnx,i-lmb */
		 0,  /* xlnx,i-opb */
		 0,  /* xlnx,i-plb */
		0xb,  /* xlnx,dcache-addr-tag */
		0x10000,  /* xlnx,dcache-byte-size */
		0x4,  /* xlnx,dcache-line-len */
		 0,  /* xlnx,dcache-use-fsl */
		0x1,  /* xlnx,dcache-use-writeback */
