...
{
	{
		...
		XPAR_AXI_GPIO_ENCODER_BASEADDR,
		XPAR_AXI_GPIO_ENCODER_INTERRUPT_PRESENT,
		XPAR_AXI_GPIO_ENCODER_IS_DUAL
	},
	{
	...
	{
		XPAR_AXI_GPIO_RGBLEDS_DEVICE_ID,
		XPAR_AXI_GPIO_RGBLEDS_BASEADDR,
		XPAR_AXI_GPIO_RGBLEDS_INTERRUPT_PRESENT,
		XPAR_AXI_GPIO_RGBLEDS_IS_DUAL
	}
};
